  ...
  return (
    <div>
      ...
      <div className="grid-container">
        ...
        <p><input type="radio" value="maestria" checked={estudios === 'maestria'}
          onChange={cambioEstudios} />Maestria</p>
        <p><input type="radio" value="especialización" checked={estudios === 'especialización'}
          onChange={cambioEstudios} />Especialización </p>
        <p><input type="radio" value="certificación" checked={estudios === 'certificación'}
          onChange={cambioEstudios} />Certificación  </p>
